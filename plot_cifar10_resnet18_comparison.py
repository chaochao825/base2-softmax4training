...
# 读取两个JSON文件
with open('results/results_cifar10_resnet18_base2.json', 'r') as f:
    data_base2 = json.load(f)

with open('results/results_cifar10_resnet18_standard.json', 'r') as f:
...
fig.suptitle('ResNet-18 on CIFAR-10: Base-2 vs Standard Softmax (First 50 Epochs)', 
             fontsize=16, fontweight='bold', y=0.98)

# 添加模型和数据集信息
model_info = 'Model: ResNet-18 | Dataset: CIFAR-10'
...
# 保存图像
output_path = 'results/comparison_cifar10_resnet18_50epochs.png'
